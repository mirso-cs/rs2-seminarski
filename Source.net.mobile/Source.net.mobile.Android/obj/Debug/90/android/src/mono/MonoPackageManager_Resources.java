...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Source.net.mobile.Android.dll" comes first in this list. */
		"Source.net.mobile.Android.dll",
		"Flurl.dll",
		"Flurl.Http.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"Source.net.mobile.dll",
